...
- [factorio-data](https://github.com/wube/factorio-data) — base game's data definitions; available locally as the `references/factorio-data` submodule (run `git submodule update --init` if missing)
